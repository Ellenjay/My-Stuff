...
Symbol BUA = 0X9C50          'Start of User Address in Flash (program memory) where User numbers and Tag numbers are stored.
...
Symbol num_UH = 200              'Maximum User History.. Keeps track of last 228 users
...
'------------------   Initialize     -----------------------
 ...
 Input SD_Detect           'Set SD Detect port as input...
