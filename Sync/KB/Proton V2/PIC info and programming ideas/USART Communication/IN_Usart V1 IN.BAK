...
DIM VAR1 AS BYTE
DIM SerString[16] AS BYTE 				' Create a 16-byte array.Loop:

Loop:
HSERIN  4000 , Timeout , [WAIT( "XYZ" ) , STR SERSTRING]

'HSERIN  4000 , Timeout , [STR SerString]  ' Fill the array with received data.

CLS
PRINT at 1,1, STR SerString 					' Display the string.

'PRINT STR VAR1 , " " ' Display the byte received
